...
interface Props {
    ...
    hasAmmo: boolean;
    onOpenChart: (symbol: string, price?: number, time?: number, timeframe?: string, side?: PositionSide | string) => void;
...
export const PositionItem: React.FC<Props> = React.memo(({
    ...
    return (
        <div 
            onClick={() => onOpenChart(p.symbol, p.entryPrice, p.entryTime, p.signalTf || '15m', p.side)}
