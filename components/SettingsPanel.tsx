...
const SettingsPanel: React.FC<Props> = React.memo(({ settings, handleChange, onFactoryReset, onOpenScanner, onToggleSim, isSimulating, onOpenManual, onRestoreSettings, onOpenSaviorLab, onUpdateBinanceRealBalance }) => {
