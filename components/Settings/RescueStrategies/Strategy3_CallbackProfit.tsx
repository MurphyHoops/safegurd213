                ...
                <div className="space-y-2 animate-in fade-in">
                    <div className="grid grid-cols-2 gap-2">
                        <div>
                            ...
                            <input type="number" className="w-full bg-slate-800 border border-slate-700 rounded px-2 py-1 text-xs text-white" value={Number.isNaN(settings.callbackHedgeRatio) ? '' : (settings.callbackHedgeRatio ?? 100)} onChange={(e) => onChange('callbackHedgeRatio', parseFloat(e.target.value))} />
                        </div>
                        <div>
